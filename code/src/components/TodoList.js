...
const BtnDoAll = styled.button`
  ...
  font-size: 14px;
  font-weight: 700;
  border: 3px solid #6dbd89;
  box-shadow: 0 0.5em 1.5em -0.5em rgba(109, 189, 137, 1);
  background-color: ${(props) => (props.clearAll ? "#6dbd89" : "#fff")};
  color: ${(props) => (props.clearAll ? "#fff" : "#6dbd89")};

  &:hover {
    background-color: ${(props) => (props.clearAll ? "#fff" : "#6dbd89")};
    color: ${(props) => (props.clearAll ? "#6dbd89" : "#fff")};
    box-shadow: none;
  }
`;
            ...
            <TodoCheckDiv>
              <div className='div-cbx '>
                <input
                  ...
                  id={item.id}
                  className='hidden-cbx cb'
                />
                <label htmlFor={item.id} className='cbx'></label>
              </div>
              <InputDiv>
                <InputP
                  className={
