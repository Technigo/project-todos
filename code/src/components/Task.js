...
// import XButton from '../assets/RemoveButton.svg';
    ...
    <TaskWrapper>
      <div className="task-row">
        ...
        <RemoveButton
          ...
          <span className="trash"><span src={Bin} /><i src={Lid} />
          </span>
        </RemoveButton>
      </div>
...
border: 2px solid ${(props) => (props.complete === true ? 'var(--text-color-light)' : '#00BBBC')};
//'var(--accent-color:)'
// border-radius: 4px;
//'#adb5bd' : '#212529'
