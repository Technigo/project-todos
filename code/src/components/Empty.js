...
const Empty = ({ selectedTab }) => {
  ...
  return (
    <div className="blobcontainer">
      ...
      {selectedTab === 'notDone' && <p>Yay you! All your todos are complete. <span role="img" className="emoji" aria-label="party emoji">🎉</span></p>}
      {selectedTab === 'done' && <p>Nothing to show here. Start doing your todos!</p>}
    </div>
  )
}
