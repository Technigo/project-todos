...
import { ProjectDropdown } from 'components/Tasks/ProjectDropdown';
  ...
  return (
    <TaskCardContainer>
      <FlexRow>
        ...
        <Button delete onClick={() => handleRemoveTask(task.id)}><MdOutlineRemoveCircle fontSize="2em" color="#FFAACF" /></Button>
      </FlexRow>
      <FlexRow>
        <ProjectDropdown taskId={task.id} optionValue={task.value} />
