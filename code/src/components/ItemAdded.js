...
return (
    ...
    <TaskForm onSubmit={handleSubmit}>
      ...
      <TaskText 
        ...
        <TaskButton type='submit' disabled={newTask.length < 5 || newTask.length >140 || emptyTask(newTask)}> + </TaskButton>
      </NewTask>
	  <TaskParagraph><p>{newTask.length} / 140 characters</p></TaskParagraph>
    </TaskForm>
