  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="2.5"
        d="M128 35s-4 6.32-4 11c0 5.556 4.654 8.044 4.654 14.063 0 4.582-4.654 9.1-4.654 9.1M116 46c-.873 5.513 3 6.532 3 11.475 0 3.762-3 7.525-3 7.525M134.795 43.474c-1.321 3.42-.579 5.503 0 6.73 1.237 2.622 3.205 4.886 3.205 7.554 0 4.648-3.205 8.947-3.205 8.947"
      ></path>
    </svg>
  );
}
